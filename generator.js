function generateNote(event) {
    ...
    var msg = 'Dear ' + giver + ", \n\n" + starting + ' ' + adj1 + ' ' + prez + ' you gave me! ' + quantitySubCaps + ' ' + quantitySubThing + ' really ' + adj2 + '. ' + custom + ' ' + 'It was so ' + giveradj + ' of you to get me ' + quantityPredFar + ' ' + giftNumber + '. ' + '\n\n' + closing + '\n\n' + recipent;
