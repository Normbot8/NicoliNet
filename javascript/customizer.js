    ...
    if (localStorage.getItem('hasAccount') === 'true') {
        ...
        if (music === "astley") {
            ...
            if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
                $('.into-pic').replaceWith('<div class=\"into-pic\"><iframe width=\"78%\" src=\"https://www.youtube.com/embed/k5pL79ywoTY\?autoplay=1&loop=1&playlist=k5pL79ywoTY\" frameborder=\"0\" allowfullscreen style=\'z-index:-10000; position:fixed\'></iframe></div>');
            }
        } else if (music === 'wham') {
            ...
            if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
                $('.into-pic').replaceWith('<div class=\"into-pic\"><iframe width=\"78%\" src=\"https://www.youtube.com/embed/gpqmoBYkQfc\?autoplay=1&loop=1&playlist=gpqmoBYkQfc\" frameborder=\"0\" style=\'z-index:-10000; position:fixed\'></iframe></div>');
            }
        }
        if (nickName === "") {
