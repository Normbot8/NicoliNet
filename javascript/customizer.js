$(function () {
    if (localStorage.getItem('hasAccount') === 'true') {
        ...
        if (music === "astley") {
            ...
            if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
                $('.into-pic').replaceWith('<div class=\"into-pic\"><iframe width=\"640\" height=\"360\" src=\"https://www.youtube.com/embed/gpqmoBYkQfc\?autoplay=1&loop=1&playlist=gpqmoBYkQfc\" frameborder=\"0\" style=\'display:block; margin: auto;\'></iframe></div>');
            }
        }
        if (nickName === "") {
