$('#submitCustomizeForm').on('click', function (event) {
    ...
    var astleyify = $('input[name=\"astleyify\"]:checked').val();
    if (astleyify === undefined) {
        $('#astleyCase').after('<span class=\"required\">Yo, yo yo, the above field is required!</span>');
        return;
    };
    var backgroundcolor = $('#backgroundColor').val();
    ...
    localStorage.setItem('astleyify', astleyify);
